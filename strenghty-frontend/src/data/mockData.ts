...
export const mockExercises: Exercise[] = [
  ...
  // Leg Day
  { id: 'ex-back-squat', name: 'Barbell Back Squat', muscleGroup: 'legs', description: '', createdAt: new Date('2024-01-01') },
  { id: 'ex-leg-press', name: 'Leg Press Machine', muscleGroup: 'legs', description: '', createdAt: new Date('2024-01-01') },
  { id: 'ex-lying-leg-curl', name: 'Lying Leg Curl Machine', muscleGroup: 'legs', description: '', createdAt: new Date('2024-01-01') },
  { id: 'ex-db-rdl', name: 'Dumbbell Romanian Deadlift', muscleGroup: 'legs', description: '', createdAt: new Date('2024-01-01') },
  { id: 'ex-leg-extension', name: 'Leg Extension Machine', muscleGroup: 'legs', description: '', createdAt: new Date('2024-01-01') },
  { id: 'ex-standing-calf-raise', name: 'Standing Calf Raise Machine', muscleGroup: 'legs', description: '', createdAt: new Date('2024-01-01') },
  ...
  // Lower Body A
  { id: 'ex-hack-squat', name: 'Hack Squat Machine', muscleGroup: 'legs', description: '', createdAt: new Date('2024-01-01') },
  { id: 'ex-bb-rdl', name: 'Barbell Romanian Deadlift (RDL)', muscleGroup: 'legs', description: '', createdAt: new Date('2024-01-01') },
  { id: 'ex-db-bulgarian-split', name: 'Dumbbell Bulgarian Split Squat', muscleGroup: 'legs', description: '', createdAt: new Date('2024-01-01') },
  { id: 'ex-seated-leg-curl', name: 'Seated Leg Curl Machine', muscleGroup: 'legs', description: '', createdAt: new Date('2024-01-01') },
  { id: 'ex-seated-calf-raise', name: 'Seated Calf Raise Machine', muscleGroup: 'legs', description: '', createdAt: new Date('2024-01-01') },
...
function ex(name: string): Exercise {
  const found = mockExercises.find((e) => e.name === name);
...
export const mockRoutines: Routine[] = [
  ...
  },
  {
    ...
    createdAt: new Date('2024-01-01'),
    exercises: [
      { id: 'r-pull-1', exercise: ex('Pull-ups (Wide or Narrow)'), targetSets: 3, targetReps: 12, order: 1 },
      { id: 'r-pull-2', exercise: ex('Barbell Bent-Over Row'), targetSets: 3, targetReps: 8, order: 2 },
      { id: 'r-pull-3', exercise: ex('Seated Cable Row (V-Bar)'), targetSets: 3, targetReps: 12, order: 3 },
  ...
  },
  {
    ...
    createdAt: new Date('2024-01-01'),
    exercises: [
      { id: 'r-legs-1', exercise: ex('Barbell Back Squat'), targetSets: 3, targetReps: 6, order: 1 },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'r-ul-ua-6', exercise: ex('Cable Bicep Curl'), targetSets: 3, targetReps: 15, order: 6 },
    ],
  },
  {
    id: 'r-lower-a',
    ...
    exercises: [
      ...
      { id: 'r-ul-la-2', exercise: ex('Barbell Romanian Deadlift (RDL)'), targetSets: 3, targetReps: 8, order: 2 },
