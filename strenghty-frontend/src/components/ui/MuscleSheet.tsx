...
type Props = {
  ...
  onOpen?: () => void;
  onClose?: () => void;
  getIcon?: (muscle: string) => string;
};

const defaultGetIcon = (muscle: string) => `${muscle}.svg`;
    ...
    >
      ...
      <div className="space-y-2">
        ...
        >
          <img
            src={`/icons/abs.svg`}
            className="h-10 w-10 rounded-full bg-white/5 p-2"
          />
          <span className="text-lg text-zinc-200">All Muscles</span>
        </button>
        {options.map((opt) => {
