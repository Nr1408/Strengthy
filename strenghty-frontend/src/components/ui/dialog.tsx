...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-black/80 backdrop-blur-md data-[state=open]:animate-none data-[state=closed]:animate-none",
      className,
    )}
    {...props}
  />
...
> & { hideClose?: boolean; overlayClassName?: string };
...
>(({ className, children, hideClose, overlayClassName, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {/* Ensure there's always a Dialog Title for accessibility (screen readers).
          If user provides their own title, having an extra visually-hidden title
          is harmless and satisfies Radix's requirement. */}
