                ...
                {(
                  ...
                  return (
                    ...
                    >
                      <div>
                        <p
                          className={`text-sm font-semibold ${isSelected ? "text-orange-400" : "text-white"}`}
                        >
                          {label}
                        </p>
                      ...
                      <div
                        className={`h-4 w-4 rounded-full border-2 flex-shrink-0 ml-3 flex items-center justify-center ${
